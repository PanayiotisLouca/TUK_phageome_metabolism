...
## Purpose of script: 
    #  Estimate heritability of indivdiual phages 
...
# -------------------------------------------------------------------------- #  
    ...
    ####   RUN LOOP OF SEM ON VIRAL CONTIG HITS  ---- 
...
path <- file.path("/scratch/users/k2480753/phages_updt/phages_heritability/Individual_phages/Output_heritibility_viral_contigs.txt")
write.table(resF,
            file = path,
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

path <- file.path("/scratch/users/k2480753/phages_updt/phages_heritability/Individual_phages/Output_heritibility_viral_contigs_CORR_SAT.txt")
write.table(res_sat, 
            file = path,
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")

path <- file.path("/scratch/users/k2480753/phages_updt/phages_heritability/Individual_phages/Output_heritibility_viral_contigs_MOD.txt")
write.table(res_mod, 
            file = path,
            col.names = FALSE, row.names = FALSE, quote = FALSE, sep = "\t")
